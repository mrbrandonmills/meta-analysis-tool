...
describe('useProjects Hook', () => {
  ...
  describe('useCreateProject', () => {
    it('creates new project', async () => {
      ...
      await waitFor(() => {
        expect(api.projectsApi.create).toHaveBeenCalledWith(newProject, expect.any(Object));
      });
    });
  ...
  describe('useDeleteProject', () => {
    it('deletes project', async () => {
      ...
      await waitFor(() => {
        expect(api.projectsApi.delete).toHaveBeenCalledWith('123', expect.any(Object));
      });
    });
  ...
  describe('usePauseProject', () => {
    it('pauses project', async () => {
      ...
      await waitFor(() => {
        expect(api.projectsApi.pause).toHaveBeenCalledWith('123', expect.any(Object));
      });
    });
  ...
  describe('useResumeProject', () => {
    it('resumes project', async () => {
      ...
      await waitFor(() => {
        expect(api.projectsApi.resume).toHaveBeenCalledWith('123', expect.any(Object));
      });
    });
  ...
  describe('useCancelProject', () => {
    it('cancels project', async () => {
      ...
      await waitFor(() => {
        expect(api.projectsApi.cancel).toHaveBeenCalledWith('123', expect.any(Object));
      });
    });
